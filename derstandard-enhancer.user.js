...
(function (global) {
  ...
  function baseItems() {
    ...
    } else if (sourceMode === "page" || sourceMode === "most") {
  ...
  function items() {
    ...
    if (sourceMode === "most") {
      list = list.filter(function (item) {
        return typeof item.commentCount === "number" && isFinite(item.commentCount) && item.commentCount >= 0;
      });
  ...
  var refresh = button("Neu laden", "");
  refresh.setAttribute("aria-label", "Quelle neu laden");
  ...
  function onSourceChange() {
    sourceMode = sourceSelect.value === "rss" || sourceSelect.value === "most" ? sourceSelect.value : "page";
